...
public class ItemRegistry {
    ...
    public static void init(RegistryEvent.Register<Item> itemRegister) {
        ...
        artichoke = registerItem(itemRegister, ARTICHOKE, new Item(createGroup().food(EDIBLE_1)));
        asparagus = registerItem(itemRegister, ASPARAGUS, new Item(createGroup().food(EDIBLE_3)));
        barley = registerItem(itemRegister, BARLEY, new Item(createGroup().food(EDIBLE_1)));
        bellPepper = registerItem(itemRegister, BELLPEPPER, new Item(createGroup().food(EDIBLE_3)));
        blackBean = registerItem(itemRegister, BLACKBEAN, new Item(createGroup().food(EDIBLE_3)));
        blackberry = registerItem(itemRegister, BLACKBERRY, new Item(createGroup().food(EDIBLE_3)));
        blueberry = registerItem(itemRegister, BLUEBERRY, new Item(createGroup().food(EDIBLE_3)));
        broccoli = registerItem(itemRegister, BROCCOLI, new Item(createGroup().food(EDIBLE_3)));
        cabbage = registerItem(itemRegister, CABBAGE, new Item(createGroup().food(EDIBLE_1)));
        cantaloupe = registerItem(itemRegister, CANTALOUPE, new Item(createGroup().food(EDIBLE_3)));
        cauliflower = registerItem(itemRegister, CAULIFLOWER, new Item(createGroup().food(EDIBLE_3)));
        celery = registerItem(itemRegister, CELERY, new Item(createGroup().food(EDIBLE_3)));
        coffeeBeans = registerItem(itemRegister, COFFEE_BEANS, new Item(createGroup().food(EDIBLE_3)));
        corn = registerItem(itemRegister, CORN, new Item(createGroup().food(EDIBLE_3)));
        cranberry = registerItem(itemRegister, CRANBERRY, new Item(createGroup().food(EDIBLE_3)));
        cucumber = registerItem(itemRegister, CUCUMBER, new Item(createGroup().food(EDIBLE_3)));
        currant = registerItem(itemRegister, CURRANT, new Item(createGroup().food(EDIBLE_3)));
        eggplant = registerItem(itemRegister, EGGPLANT, new Item(createGroup().food(EDIBLE_3)));
        elderberry = registerItem(itemRegister, ELDERBERRY, new Item(createGroup().food(EDIBLE_3)));
        garlic = registerItem(itemRegister, GARLIC, new Item(createGroup().food(EDIBLE_1)));
        grape = registerItem(itemRegister, GRAPE, new Item(createGroup().food(EDIBLE_3)));
        greenBean = registerItem(itemRegister, GREENBEAN, new Item(createGroup().food(EDIBLE_3)));
        greenOnion = registerItem(itemRegister, GREENONION, new Item(createGroup().food(EDIBLE_1)));
        honeydew = registerItem(itemRegister, HONEYDEW, new Item(createGroup().food(EDIBLE_3)));
        hops = registerItem(itemRegister, HOPS, new Item(createGroup()));
        kale = registerItem(itemRegister, KALE, new Item(createGroup().food(EDIBLE_3)));
        kiwi = registerItem(itemRegister, KIWI, new Item(createGroup().food(EDIBLE_3)));
        leek = registerItem(itemRegister, LEEK, new Item(createGroup().food(EDIBLE_3)));
        lettuce = registerItem(itemRegister, LETTUCE, new Item(createGroup().food(EDIBLE_3)));
        oat = registerItem(itemRegister, OAT, new Item(createGroup().food(EDIBLE_1)));
        olive = registerItem(itemRegister, OLIVE, new Item(createGroup().food(EDIBLE_3)));
        onion = registerItem(itemRegister, ONION, new Item(createGroup().food(EDIBLE_3)));
        peanut = registerItem(itemRegister, PEANUT, new Item(createGroup().food(EDIBLE_1)));
        pineapple = registerItem(itemRegister, PINEAPPLE, new Item(createGroup().food(EDIBLE_3)));
        radish = registerItem(itemRegister, RADISH, new Item(createGroup().food(EDIBLE_3)));
        raspberry = registerItem(itemRegister, RASPBERRY, new Item(createGroup().food(EDIBLE_3)));
        rhubarb = registerItem(itemRegister, RHUBARB, new Item(createGroup().food(EDIBLE_3)));
        rice = registerItem(itemRegister, RICE, new Item(createGroup().food(EDIBLE_1)));
        rutabaga = registerItem(itemRegister, RUTABAGA, new Item(createGroup().food(EDIBLE_3)));
        saguaro = registerItem(itemRegister, SAGUARO, new Item(createGroup().food(EDIBLE_3)));
        soybean = registerItem(itemRegister, SOYBEAN, new Item(createGroup().food(EDIBLE_1)));
        spinach = registerItem(itemRegister, SPINACH, new Item(createGroup().food(EDIBLE_3)));
        squash = registerItem(itemRegister, SQUASH, new Item(createGroup().food(EDIBLE_3)));
        strawberry = registerItem(itemRegister, STRAWBERRY, new Item(createGroup().food(EDIBLE_3)));
        sweetPotato = registerItem(itemRegister, SWEETPOTATO, new Item(createGroup().food(EDIBLE_3)));
        tomatillo = registerItem(itemRegister, TOMATILLO, new Item(createGroup().food(EDIBLE_3)));
        tomato = registerItem(itemRegister, TOMATO, new Item(createGroup().food(EDIBLE_3)));
        turnip = registerItem(itemRegister, TURNIP, new Item(createGroup().food(EDIBLE_3)));
        yam = registerItem(itemRegister, YAM, new Item(createGroup().food(EDIBLE_3)));
        zucchini = registerItem(itemRegister, ZUCCHINI, new Item(createGroup().food(EDIBLE_3)));
