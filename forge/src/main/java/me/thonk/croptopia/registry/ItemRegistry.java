...
public class ItemRegistry {
    ...
    public static Item appleSapling = registerItem(ItemNames.APPLE_SAPLING, new BlockNamedItem(BlockRegistry.appleSaplingBlock, createGroup()));
    public static Item bananaSapling = registerItem(ItemNames.BANANA_SAPLING, new BlockNamedItem(BlockRegistry.bananaSaplingBlock, createGroup()));
    public static Item orangeSapling = registerItem(ItemNames.ORANGE_SAPLING, new BlockNamedItem(BlockRegistry.orangeSaplingBlock, createGroup()));
    public static Item persimmonSapling = registerItem(ItemNames.PERSIMMON_SAPLING, new BlockNamedItem(BlockRegistry.persimmonSaplingBlock, createGroup()));
    public static Item plumSapling = registerItem(ItemNames.PLUM_SAPLING, new BlockNamedItem(BlockRegistry.plumSaplingBlock, createGroup()));
    public static Item cherrySapling = registerItem(ItemNames.CHERRY_SAPLING, new BlockNamedItem(BlockRegistry.cherrySaplingBlock, createGroup()));
    public static Item lemonSapling = registerItem(ItemNames.LEMON_SAPLING, new BlockNamedItem(BlockRegistry.lemonSaplingBlock, createGroup()));
    public static Item grapefruitSapling = registerItem(ItemNames.GRAPEFRUIT_SAPLING, new BlockNamedItem(BlockRegistry.grapefruitSaplingBlock, createGroup()));
    public static Item kumquatSapling = registerItem(ItemNames.KUMQUAT_SAPLING, new BlockNamedItem(BlockRegistry.kumquatSaplingBlock, createGroup()));
    public static Item peachSapling = registerItem(ItemNames.PEACH_SAPLING, new BlockNamedItem(BlockRegistry.peachSaplingBlock, createGroup()));
    public static Item coconutSapling = registerItem(ItemNames.COCONUT_SAPLING, new BlockNamedItem(BlockRegistry.coconutSaplingBlock, createGroup()));
    public static Item nutmegSapling = registerItem(ItemNames.NUTMEG_SAPLING, new BlockNamedItem(BlockRegistry.nutmegSaplingBlock, createGroup()));
    public static Item figSapling = registerItem(ItemNames.FIG_SAPLING, new BlockNamedItem(BlockRegistry.figSaplingBlock, createGroup()));
    public static Item nectarineSapling = registerItem(ItemNames.NECTARINE_SAPLING, new BlockNamedItem(BlockRegistry.nectarineSaplingBlock, createGroup()));
    public static Item mangoSapling = registerItem(ItemNames.MANGO_SAPLING, new BlockNamedItem(BlockRegistry.mangoSaplingBlock, createGroup()));
    public static Item dragonFruitSapling = registerItem(ItemNames.DRAGONFRUIT_SAPLING, new BlockNamedItem(BlockRegistry.dragonFruitSaplingBlock, createGroup()));
    public static Item starFruitSapling = registerItem(ItemNames.STARFRUIT_SAPLING, new BlockNamedItem(BlockRegistry.starFruitSaplingBlock, createGroup()));
    public static Item avocadoSapling = registerItem(ItemNames.AVOCADO_SAPLING, new BlockNamedItem(BlockRegistry.avocadoSaplingBlock, createGroup()));
    public static Item apricotSapling = registerItem(ItemNames.APRICOT_SAPLING, new BlockNamedItem(BlockRegistry.apricotSaplingBlock, createGroup()));
    public static Item pearSapling = registerItem(ItemNames.PEAR_SAPLING, new BlockNamedItem(BlockRegistry.pearSaplingBlock, createGroup()));
    public static Item limeSapling = registerItem(ItemNames.LIME_SAPLING, new BlockNamedItem(BlockRegistry.limeSaplingBlock, createGroup()));
    public static Item dateSapling = registerItem(ItemNames.DATE_SAPLING, new BlockNamedItem(BlockRegistry.dateSaplingBlock, createGroup()));
    public static Item almondSapling = new BlockNamedItem(BlockRegistry.almondSaplingBlock, createGroup());
    public static Item cashewSapling = new BlockNamedItem(BlockRegistry.cashewSaplingBlock, createGroup());
    public static Item pecanSapling = new BlockNamedItem(BlockRegistry.pecanSaplingBlock, createGroup());
    public static Item walnutSapling = new BlockNamedItem(BlockRegistry.walnutSaplingBlock, createGroup());
    ...
    // drinks
    public static Item grapeJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item orangeJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item appleJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item cranberryJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item saguaroJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item tomatoJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item melonJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item pineappleJuice = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item coffee = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item lemonade = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item limeade = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item soyMilk = new Drink(createGroup().food(EDIBLE_5_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    //public static Item tea;

    public static Item strawberrySmoothie = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));
    public static Item bananaSmoothie = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));
    public static Item kaleSmoothie = new Drink(createGroup().food(EDIBLE_14_BUILDER.setAlwaysEdible().build()));
    public static Item fruitSmoothie = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));

    public static Item chocolateMilkshake = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));

    public static Item beer = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));
    public static Item wine = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));
    public static Item mead = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));
    public static Item rum = new Drink(createGroup().food(EDIBLE_7_BUILDER.setAlwaysEdible().build()));
    public static Item pumpkinSpiceLatte = new Drink(createGroup().food(EDIBLE_14_BUILDER.setAlwaysEdible().build()));

    // jams
    public static Item grapeJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item strawberryJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item peachJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item apricotJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item blackberryJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item blueberryJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item cherryJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item elderberryJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    public static Item raspberryJam = new Drink(createGroup().food(EDIBLE_3_BUILDER.setAlwaysEdible().build()).containerItem(Items.GLASS_BOTTLE));
    ...
    // cooking utensils?
    public static Item foodPress = new Item(createGroup().maxStackSize(1).defaultMaxDamage(500));
    public static Item fryingPan = new SwordItem(ItemTier.IRON, 5, -1.0F, createGroup().maxStackSize(1).defaultMaxDamage(500));
    public static Item cookingPot = new Item(createGroup().maxStackSize(1).defaultMaxDamage(500));
    public static Item mortarAndPestle = new Item(createGroup().maxStackSize(1).defaultMaxDamage(500));

    public static Item saltOre = new BlockNamedItem(BlockRegistry.salt, createGroup());
