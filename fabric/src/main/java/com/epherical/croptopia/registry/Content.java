...
public class Content {
    ...
    public enum Farmland implements ItemConvertibleWithPlural, BlockConvertible {
         ...
         * @param shortNameVariant A variant of this entry's name that is used for suffixes instead of its name. Optional, see {@link #Farmland(boolean, TagCategory, FoodConstructor, Biome.BiomeCategory...)}.
         ...
         */
        Farmland(String shortNameVariant, boolean hasPlural, TagCategory tagegory, FoodConstructor foodRegistry, Biome.BiomeCategory... biomes) {
        ...
        /**
         * @see #Farmland(String, boolean, TagCategory, FoodConstructor, Biome.BiomeCategory...)
         */
        Farmland(boolean hasPlural, TagCategory tagegory, FoodConstructor foodRegistry, Biome.BiomeCategory... biomes) {
    ...
    public enum Tree implements ItemConvertibleWithPlural, BlockConvertible {
         ...
         */
        Tree(boolean hasPlural, Block logType, Block leafType, TagCategory tagegory, FoodConstructor foodRegistry, int iTreeGen, int jTreeGen, int kTreeGen) {
    ...
    public enum Seafood implements ItemConvertibleWithPlural {
        ...
        Seafood(boolean hasPlural, FoodConstructor foodRegistry) {
            this.hasPlural = hasPlural;
            if (name().contains("GLOWING")) {
                item = new Item(createGroup().food(FoodConstructor.createBuilder(foodRegistry)
    ...
    public enum Furnace implements ItemConvertibleWithPlural {
        ...
        Furnace(boolean hasPlural, FoodConstructor foodRegistry) {
            this.hasPlural = hasPlural;
            if (foodRegistry == null) {
                item = new Item(createGroup());
            }
