...
public class TreeGeneratorRegistry {
    ...
    public static final ConfiguredFeature<?, ?> COCONUT_TREE = registerTree(createIdentifier("coconut_tree"),
            Feature.TREE.configure((new TreeFeatureConfig.Builder(
                    ...
                    new TwoLayersFeatureSize(1, 0, 2))).ignoreVines().build()).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP.decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(0, 0.1F, 1)))));
